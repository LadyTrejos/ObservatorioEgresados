...
DATABASES = {
    'default': {
        'ENGINE': 'djongo',
        'NAME': 'ClusterObservatorio',
        'HOST': 'mongodb://admin:adminpass@clusterobservatorio-shard-00-00-hvwre.mongodb.net:27017,clusterobservatorio-shard-00-01-hvwre.mongodb.net:27017,clusterobservatorio-shard-00-02-hvwre.mongodb.net:27017/test?ssl=true&replicaSet=ClusterObservatorio-shard-0&authSource=admin&retryWrites=true&w=majority',
        'USER': 'admin',
        'PASSWORD': 'adminpass'
    }
}
...
EMAIL_HOST_USER = 'ladytrejosh@gmail.com'
EMAIL_HOST_PASSWORD = 'enviarcorreos123*'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
SEND_GRID_API_KEY = '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'
